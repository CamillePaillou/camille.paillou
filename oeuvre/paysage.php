...
<?php require_once __DIR__ . '/../partials/menuart.php'; ?>
    ...
    <div class="dev-container">
        <div class="flecheprev-dev"><a href="couverture.php">&larr;</a></div>
        <div class="titre-site">Paysage</div>
        <div class="flechesuiv-dev"><a href="vague.php">&rarr;</a></div>
    </div>

    <div>
        <img src="../images/art/paysage/1.webp" alt="Départ" class="zoom-modal thumbnail img-horiz" onclick="openModal(0)"> 
        <img src="../images/art/paysage/2.webp" alt="Image 2" class="zoom-modal thumbnail img-horiz" onclick="openModal(1)">
    </div>

    <section>
        <div class="art-p">
            <p><strong>Paysage</strong></p>
            <p>2024<br>papier, peinture</p>
        </div>
    </section>
