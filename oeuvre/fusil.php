...
<?php require_once __DIR__ . '/../partials/menuart.php'; ?>
    ...
    <div class="dev-container">
        <div class="flecheprev-dev"><a href="omerta.php">&larr;</a></div>
        <div class="titre-site">Fusil</div>
        <div class="flechesuiv-dev"><a href="lit.php">&rarr;</a></div>
    </div>

    <div>
        <img src="../images/art/fusil/1.webp" alt="Départ" class="zoom-modal thumbnail img-horiz" onclick="openModal(0)"> 
    </div>

    <section>
        <div class="art-p">
            <p><strong>Fusil</strong></p>
            <p>2024<br>bâche plastique, tissu</p>
        </div>
    </section>
