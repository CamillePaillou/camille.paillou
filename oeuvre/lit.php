...
<?php require_once 'partials/menuart.php'; ?>
    ...
    <div class="dev-container">
        <div class="flecheprev-dev"><a href="fusil.html">&larr;</a></div>
        <div class="flechesuiv-dev"><a href="couverture.html">&rarr;</a></div>
    </div>
    <div class="colonne-dev">
        <div class="dev-image">
            <img src="/images/art/lit/1.webp"> 
            <img src="/images/art/lit/2.webp">
        </div>
        <div class="dev-p">
