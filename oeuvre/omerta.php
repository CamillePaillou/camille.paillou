...
<?php require_once 'partials/menuart.php'; ?>
    ...
    <div class="dev-container">
        <div class="flecheprev-dev"><a href="culpabilite.html">&larr;</a></div>
        <div class="flechesuiv-dev"><a href="fusil.html">&rarr;</a></div>
    </div>
    <div class="colonne-art">
        <div class="images-superposees">
            <img src="/images/art/omerta/1.webp" class="img-verti"> 
            <img src="/images/art/omerta/2.webp"class="img-horiz">
        </div>
        <div class="dev-p">
