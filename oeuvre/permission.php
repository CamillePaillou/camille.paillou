...
<?php require_once __DIR__ . '/../partials/menuart.php'; ?>
    ...
    <div class="dev-container">
        ...
        <div class="titre-site">Permission</div>
        <div class="flechesuiv-dev"><a href="rouleau.php">&rarr;</a></div>
    </div>

    <div>
        <img src="../images/art/permission/3.webp" alt="Départ" class="zoom-modal thumbnail img-horiz" onclick="openModal(0)"> 
        <img src="../images/art/permission/1.webp" alt="Image 2" class="zoom-modal thumbnail img-horiz" onclick="openModal(1)">
        <img src="../images/art/permission/2.webp" alt="Image 3" class="zoom-modal thumbnail img-horiz" onclick="openModal(2)">
    ...
    <section>
        <div class="art-p">
            ...
            <p>Performance<br>2025<br>5 min</p>
        </div>
    </section>
