...
<?php require_once 'partials/menuart.php'; ?>
    ...
    <div class="dev-container">
        <div class="flecheprev-dev"><a href="accrochage.html">&larr;</a></div>
        <div class="flechesuiv-dev"><a href="emprise.html">&rarr;</a></div>
    </div>
    <div class="colonne-dev">
        <div class="art-verti">
            <img src="/images/art/obeissance/1.webp"> 
        </div>
        <div class="dev-p">
            <p><strong>Obéissance</strong></p>
