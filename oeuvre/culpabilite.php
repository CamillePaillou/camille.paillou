...
<?php require_once __DIR__ . '/../partials/menuart.php'; ?>
    ...
    <div class="dev-container">
        <div class="flecheprev-dev"><a href="memoire.php">&larr;</a></div>
        <div class="titre-site">Culpabilité</div>
        <div class="flechesuiv-dev"><a href="omerta.php">&rarr;</a></div>
    </div>

    <div>
        <img src="../images/art/culpabilite/1.webp" alt="Départ" class="zoom-modal thumbnail img-horiz" onclick="openModal(0)"> 
        <img src="../images/art/culpabilite/2.webp" alt="Image 2" class="zoom-modal thumbnail img-horiz" onclick="openModal(1)">
    </div>
